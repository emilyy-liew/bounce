...
async function addRevalidationHeader(res, staticGenerationStore) {
    ...
    res.setHeader("x-action-revalidated", JSON.stringify([
        ((_staticGenerationStore_revalidatedTags = staticGenerationStore.revalidatedTags) == null ? void 0 : _staticGenerationStore_revalidatedTags.length) ? 1 : 0,
        []
    ]));
}
