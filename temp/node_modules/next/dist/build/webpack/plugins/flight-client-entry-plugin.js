    ...
    async createClientEntries(compiler, compilation) {
        ...
        compilation.hooks.afterOptimizeModules.tap(PLUGIN_NAME, ()=>{
            ...
            (0, _utils1.forEachEntryModule)(compilation, ({ name , entryModule  })=>{
                ...
                Object.assign(cssManifest.cssImports, deduplicateCSSImportsForEntry(mergedCSSimports));
            });
        });
        compilation.hooks.processAssets.tap({
            name: PLUGIN_NAME,
            ...
            assets[`${this.assetPrefix}${_constants1.FLIGHT_SERVER_CSS_MANIFEST}.js`] = new _webpack.sources.RawSource(`self.__RSC_CSS_MANIFEST=${JSON.stringify(manifest)}`);
        });
